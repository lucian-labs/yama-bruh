...
const YAMABRUH_PRESETS = [
  ...
  [1.0,7.0,2.0,0.001,0.7,0.12,0.6,0.0],[1.0,3.0,3.0,0.001,0.3,0.0,0.2,0.02],
  [1.0,4.0,3.5,0.001,0.25,0.0,0.18,0.04],[1.0,5.0,2.8,0.001,0.35,0.0,0.22,0.06],
  [1.0,5.0,4.5,0.001,0.15,0.05,0.08,0.1],[1.0,13.0,1.5,0.001,1.5,0.0,2.0,0.0],
  // 10-19: Organ
  [1.0,1.0,0.6,0.01,0.05,0.85,0.1,0.05],[1.0,1.0,0.4,0.015,0.08,0.75,0.15,0.03],
  [1.0,2.0,0.8,0.012,0.06,0.8,0.12,0.06],[1.0,2.0,2.5,0.003,0.02,0.95,0.04,0.2],
  [1.0,4.0,2.2,0.003,0.02,0.88,0.04,0.1],[1.0,1.0,1.5,0.005,0.02,0.9,0.05,0.12],
  [1.0,3.0,1.2,0.008,0.05,0.8,0.08,0.25],[1.0,4.0,2.0,0.001,2.5,0.05,3.0,0.0],
  [1.0,4.0,4.0,0.001,0.6,0.0,0.5,0.02],[1.0,3.0,3.5,0.001,0.5,0.0,0.4,0.03],
  // 20-29: Brass
  [1.0,1.0,4.0,0.04,0.15,0.7,0.2,0.2],[1.0,1.0,2.0,0.03,0.12,0.4,0.15,0.1],
  [1.0,1.0,3.5,0.06,0.2,0.65,0.3,0.25],[1.0,1.0,2.8,0.07,0.25,0.55,0.35,0.2],
  [1.0,1.0,2.5,0.08,0.25,0.6,0.4,0.15],[1.0,1.0,1.8,0.12,0.3,0.5,0.5,0.08],
  [0.5,1.0,3.0,0.06,0.2,0.6,0.3,0.2],[1.0,1.0,5.0,0.05,0.15,0.75,0.25,0.3],
  [1.0,2.0,4.5,0.03,0.1,0.8,0.2,0.18],[1.0,3.0,6.0,0.02,0.08,0.85,0.15,0.22],
  // 30-39: Woodwind
  [2.0,1.0,1.0,0.02,0.05,0.7,0.1,0.05],[2.0,1.0,0.5,0.03,0.06,0.6,0.12,0.02],
  [2.0,1.0,1.8,0.01,0.04,0.75,0.08,0.08],[1.0,3.0,3.0,0.015,0.06,0.65,0.08,0.2],
  [0.5,3.0,2.5,0.02,0.08,0.6,0.1,0.18],[1.0,2.0,4.0,0.02,0.08,0.6,0.1,0.15],
  [0.5,1.0,3.5,0.03,0.1,0.55,0.12,0.2],[1.0,2.0,3.5,0.025,0.07,0.65,0.1,0.22],
  [1.0,3.0,2.0,0.02,0.04,0.8,0.08,0.35],[1.0,2.0,2.5,0.02,0.06,0.7,0.1,0.12],
  // 40-49: Strings / Bass / Plucked
  [1.0,2.0,1.0,0.15,0.5,0.7,0.8,0.02],[1.0,2.0,1.5,0.12,0.4,0.65,0.7,0.04],
  [0.5,2.0,1.2,0.1,0.5,0.6,0.8,0.03],[1.0,2.0,0.8,0.2,0.6,0.7,1.0,0.02],
  [1.0,1.0,2.0,0.001,0.3,0.2,0.12,0.05],[1.0,1.0,5.0,0.001,0.08,0.05,0.06,0.2],
  [1.0,1.0,0.8,0.005,0.4,0.35,0.2,0.0],[0.5,1.0,4.0,0.001,0.2,0.25,0.1,0.15],
  [1.0,3.0,3.5,0.001,0.15,0.0,0.08,0.1],[1.0,4.0,2.5,0.001,0.2,0.0,0.1,0.06],
  // 50-59: Guitar / Plucked / Folk
  [1.0,2.0,1.8,0.001,0.5,0.1,0.3,0.03],[1.0,3.0,2.2,0.001,0.35,0.08,0.25,0.06],
  [1.0,2.0,2.5,0.001,0.4,0.05,0.2,0.04],[1.0,1.0,1.5,0.001,0.8,0.15,0.5,0.02],
  [1.0,5.0,2.0,0.001,0.2,0.0,0.15,0.05],[1.0,2.0,3.0,0.001,0.6,0.0,0.4,0.08],
  [1.0,3.0,4.0,0.001,0.3,0.0,0.2,0.1],[1.0,7.0,1.5,0.001,1.5,0.0,1.8,0.01],
  [1.0,1.0,2.5,0.02,0.08,0.7,0.1,0.3],[1.0,7.0,2.5,0.001,1.5,0.0,2.0,0.01],
  // 60-69: Combo / Synth
  [1.0,4.0,4.5,0.03,0.4,0.5,0.3,0.15],[2.0,3.0,2.0,0.01,0.3,0.4,0.25,0.05],
  [1.0,4.0,3.0,0.02,0.5,0.3,0.4,0.1],[1.0,7.0,2.0,0.02,0.6,0.35,0.5,0.08],
  [1.0,1.41,5.0,0.1,0.5,0.5,0.6,0.06],[1.0,1.0,3.0,0.05,0.3,0.7,0.4,0.4],
  [1.0,2.0,4.5,0.02,0.06,0.85,0.12,0.18],[1.0,7.0,6.0,0.01,0.08,0.7,0.15,0.3],
  [1.0,1.0,0.0,0.01,0.02,0.9,0.1,0.0],[1.0,1.0,2.5,0.001,0.01,0.8,0.8,0.1],
  // 70-79: Human Voice / Nature
  [1.0,1.0,0.8,0.08,0.15,0.65,0.3,0.5],[1.0,2.0,1.2,0.06,0.2,0.6,0.35,0.45],
  [1.0,3.0,0.6,0.1,0.25,0.55,0.4,0.55],[1.0,1.0,0.3,0.15,0.3,0.4,0.5,0.6],
  [2.0,1.0,0.8,0.02,0.05,0.7,0.1,0.15],[1.0,0.5,4.0,0.08,0.3,0.5,0.4,0.7],
  [1.0,0.25,3.0,0.05,0.4,0.3,0.5,0.6],[1.0,13.0,1.0,0.001,1.5,0.0,2.0,0.0],
  [1.0,7.0,5.0,0.001,0.06,0.0,0.04,0.15],[1.0,11.0,2.0,0.001,0.8,0.0,1.0,0.0],
  // 80-89: SFX / Novelty
  [1.0,0.99,8.0,0.01,0.3,0.5,0.4,0.8],[2.0,0.5,6.0,0.001,0.08,0.3,0.06,0.5],
  [1.0,5.0,2.0,0.001,0.6,0.0,0.8,0.02],[1.0,11.0,3.0,0.001,0.05,0.0,0.02,0.0],
  [1.0,1.0,6.0,0.001,0.02,0.9,0.02,0.4],[1.0,0.1,12.0,0.001,0.5,0.0,0.8,0.7],
  [1.0,5.0,4.0,0.15,1.0,0.5,2.0,0.08],[1.0,0.5,10.0,0.001,0.6,0.0,1.5,0.6],
  [1.0,13.0,2.5,0.001,2.0,0.0,2.5,0.0],[1.0,0.5,8.0,0.3,1.5,0.4,2.0,0.8],
  // 90-99: Percussion / FX
  [1.0,3.5,5.0,0.001,2.0,0.0,2.5,0.0],[1.0,5.4,3.0,0.001,1.5,0.0,2.0,0.0],
  [1.0,3.5,4.0,0.001,1.8,0.0,2.2,0.01],[1.0,1.41,7.0,0.001,1.2,0.0,1.5,0.05],
  [1.0,0.7,3.0,0.001,0.4,0.0,0.3,0.02],[1.0,1.5,8.0,0.001,0.3,0.0,0.2,0.3],
  [0.5,1.5,6.0,0.001,0.4,0.0,0.25,0.25],[1.0,2.3,10.0,0.001,0.12,0.0,0.08,0.15],
  [1.0,0.1,15.0,0.001,0.04,0.0,0.03,0.8],[1.0,7.0,3.0,0.3,2.0,0.3,3.0,0.1],
];
